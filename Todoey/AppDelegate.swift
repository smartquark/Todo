...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    // user prints home button and enters another app with huge resources the iphone will kill this app. resources reclaimed - no longer in background - tereminated
    }
